...
class MyTestCase(unittest.TestCase):
    def test_fetch_children_success(self):
        fleet = fetch_child_safes("0x20026f06342e16415b070ae3bdb3983af7c51c95")
    ...
    def test_fetch_children_fail(self):
        with self.assertRaises(ValueError) as err:
            fetch_child_safes("0xa421e74a7ebc8f3354b7352ba7841084b701e85f")
        self.assertEqual(
            str(err.exception),
            "No results returned for parent 0xa421e74a7ebc8f3354b7352ba7841084b701e85f",
        )
        with self.assertRaises(ValueError) as err:
            fetch_child_safes("0xBadAddress")
        self.assertEqual(
